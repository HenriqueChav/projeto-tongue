...
<html lang="pt-br">
  ...
  <body class="bg-light">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link active">Editar</a>
                    </li> 
        ...
        <div class="container">
            <div class="row">
                <div class="col-4 offset-2">
                    <button id="btnBiblioteca" class="btn btn-warning">Editar Biblioteca</button>
                </div>
                <div class="col-4">
                    <button id="btnExercicios" class="btn btn-warning">Editar Exercícios</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="js/editarScript.js"></script>
  </body>
</html>